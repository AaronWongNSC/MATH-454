...
Two groups can be used to create a new group which we shall call the direct product. Last semester we saw the direct product of rings whose additive structure was an abelian group. We will try to discover the algebraic structure of direct products and ty to see which groups "secretly" have the structure of a direct product already.
